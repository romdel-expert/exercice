...
<div class="container-fluid content-page text-center">
	<div class="row">
		...
		style="border:1px solid rgba(158,134,75,1); padding: 50px; traslateY(-50%);">
			<h1 class="official-color-text">OPERATION DE DEPOT</h1>
			
			<h5>Pour un montant supérieur à 1000 euros, contactez votre conseiller</h5>
			...
			<div class="container-fluid text-center" style="">
				  <div class="row">
			  			...
			  			<div class="col-6">
		  					<div class="form-group">
							    ...
							    <input type="text" class="form-control" placeholder="Entrer le montant" id="amount"
							    ng-model="amount" ng-keypress="setAsNumberAmount(); clearField();" maxlength="7">
						  	</div>
				  ...
				  <div class="row" style="margin:40px 0px;">
			  			...
			  			<div class="col-6">
						  	<button type="button" class="btn btn-official" ng-click="makeDeposit();">Valider</button>
			  			</div>
				  </div>
				  
				  <p style="color: red;">{{err_deposit}}</p>
			</div>
